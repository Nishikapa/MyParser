...
namespace MyParser
{
    internal abstract class 既定 { }

    internal class コメント : 既定 { }

    internal class ブランク : 既定 { }

    internal class 繰り返し始まり : 既定
    {
    ...
    internal class 繰り返し終わり : 既定 { }

    internal class 表示 : 既定
    {
    ...
    internal static partial class Program
    {
        ...
        private static パーサー<char, コメント> コメントのパーサー =>
            from v1 in 文字列("//")
            from v2 in 任意の一文字.零回以上の繰り返し()
            from v3 in 末尾
            select new コメント();

        private static パーサー<char, ブランク> ブランクのパーサー =>
            from v1 in 空白一文字.零回以上の繰り返し()
            from v2 in 末尾
            select new ブランク();

        private static パーサー<char, 繰り返し始まり> 繰り返し始まりのパーサー =>
            from v1 in 文字列("#FOR")
        ...
        private static パーサー<char, 繰り返し終わり> 繰り返し終わりのパーサー =>
            from v1 in 文字列("#ENDFOR")
            from v2 in 空白一文字.零回以上の繰り返し()
            from v3 in 末尾
            select new 繰り返し終わり();

        private static パーサー<char, 表示> 表示のパーサー =>
        ...
        private static パーサー<char, 既定> 一行のパーサー =>
            何れか一つ<char, 既定>(
                コメントのパーサー,
                ブランクのパーサー,
                繰り返し始まりのパーサー,
        ...
        private static パーサー<既定, 繰り返し> 繰り返しのパーサー =>
        ...
        private static パーサー<既定, IEnumerable<既定>> 二段目のパーサー =>
        ...
        {
            {
                var すべての行 = File.ReadAllLines(@"..\..\test.txt");
